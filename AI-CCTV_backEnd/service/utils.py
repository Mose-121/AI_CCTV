...
# Preview Enhancement
# ==============================
def enhance_preview(frame: np.ndarray) -> np.ndarray:
    """
    Apply CLAHE-based enhancement to make preview frames look better.
    Adjusts contrast and brightness adaptively without over-saturating.
    """
